package com.apolloclinicfsm.features.logoutsync.presentation
...
import com.apolloclinicfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.apolloclinicfsm.features.billing.api.AddBillingRepoProvider
import com.apolloclinicfsm.features.billing.model.AddBillingInputParamsModel
...
import com.apolloclinicfsm.features.dashboard.presentation.ReasonDialog
...
import com.apolloclinicfsm.features.document.model.AddEditDocumentInputParams
import com.apolloclinicfsm.features.document.model.DocumentAttachmentModel
...
import com.apolloclinicfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.apolloclinicfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.apolloclinicfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.apolloclinicfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.apolloclinicfsm.features.orderhistory.model.*
...
import com.apolloclinicfsm.features.quotation.model.AddQuotInputModel
import com.apolloclinicfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.apolloclinicfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.apolloclinicfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.apolloclinicfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.apolloclinicfsm.features.timesheet.model.AddTimeSheetInputModel
import com.apolloclinicfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.apolloclinicfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.apolloclinicfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.apolloclinicfsm.mappackage.SendBrod
import com.apolloclinicfsm.widgets.AppCustomTextView
import com.apolloclinicfsm.MonitorService
...
import com.apolloclinicfsm.features.login.model.GetConcurrentUserResponse
import com.apolloclinicfsm.features.login.model.WhatsappApiData
import com.apolloclinicfsm.features.performance.model.Gps_status_list
import com.apolloclinicfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.apolloclinicfsm.features.returnsOrder.ReturnProductList
import com.apolloclinicfsm.features.returnsOrder.ReturnRequest
import com.apolloclinicfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicfsmlogsample/log.zip").path);
