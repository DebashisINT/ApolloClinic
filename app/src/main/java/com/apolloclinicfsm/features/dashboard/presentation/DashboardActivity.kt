package com.apolloclinicfsm.features.dashboard.presentation
...
import com.apolloclinicfsm.*
import com.apolloclinicfsm.R
import com.apolloclinicfsm.app.*
import com.apolloclinicfsm.app.NewFileUtils.browseDocuments
import com.apolloclinicfsm.app.NewFileUtils.getExtension
import com.apolloclinicfsm.app.domain.*
import com.apolloclinicfsm.app.types.DashboardType
import com.apolloclinicfsm.app.types.FragType
import com.apolloclinicfsm.app.types.TopBarConfig
import com.apolloclinicfsm.app.uiaction.DisplayAlert
import com.apolloclinicfsm.app.utils.*
import com.apolloclinicfsm.app.utils.AppUtils.Companion.isProfile
...
import com.apolloclinicfsm.features.NewQuotation.*
import com.apolloclinicfsm.features.NewQuotation.api.GetQuotRegProvider
import com.apolloclinicfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.apolloclinicfsm.features.SearchLocation.SearchLocationFragment
import com.apolloclinicfsm.features.SearchLocation.locationInfoModel
import com.apolloclinicfsm.features.TA.ViewAllTAListFragment
import com.apolloclinicfsm.features.achievement.AchievementFragment
import com.apolloclinicfsm.features.activities.presentation.*
import com.apolloclinicfsm.features.addAttendence.*
import com.apolloclinicfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.apolloclinicfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.apolloclinicfsm.features.addAttendence.model.GetReportToFCMResponse
import com.apolloclinicfsm.features.addAttendence.model.GetReportToResponse
import com.apolloclinicfsm.features.addAttendence.model.Leave_list_Response
import com.apolloclinicfsm.features.addorder.presentation.AddOrderFragment
...
import com.apolloclinicfsm.features.addshop.presentation.AddShopFragment
import com.apolloclinicfsm.features.addshop.presentation.OTPVerificationDialog
import com.apolloclinicfsm.features.addshop.presentation.ScanImageFragment
import com.apolloclinicfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.apolloclinicfsm.features.alarm.model.AlarmData
import com.apolloclinicfsm.features.alarm.presetation.AttendanceReportFragment
import com.apolloclinicfsm.features.alarm.presetation.PerformanceReportFragment
import com.apolloclinicfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.apolloclinicfsm.features.alarm.presetation.VisitReportFragment
import com.apolloclinicfsm.features.attendance.AttendanceFragment
import com.apolloclinicfsm.features.attendance.api.AttendanceRepositoryProvider
import com.apolloclinicfsm.features.attendance.model.AttendanceRequest
import com.apolloclinicfsm.features.attendance.model.AttendanceResponse
import com.apolloclinicfsm.features.averageshop.presentation.AverageShopFragment
import com.apolloclinicfsm.features.avgorder.presentation.AverageOrderFragment
import com.apolloclinicfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.apolloclinicfsm.features.beatCustom.TeamBeatListFragment
import com.apolloclinicfsm.features.billing.presentation.AddBillingFragment
import com.apolloclinicfsm.features.billing.presentation.BillingDetailsFragment
import com.apolloclinicfsm.features.billing.presentation.BillingListFragment
import com.apolloclinicfsm.features.changepassword.presentation.ChangePasswordDialog
import com.apolloclinicfsm.features.chat.model.ChatListDataModel
import com.apolloclinicfsm.features.chat.model.ChatUserDataModel
import com.apolloclinicfsm.features.chat.model.GroupUserDataModel
import com.apolloclinicfsm.features.chat.presentation.*
import com.apolloclinicfsm.features.chatbot.presentation.ChatBotFragment
import com.apolloclinicfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.apolloclinicfsm.features.chatbot.presentation.ReportsFragment
import com.apolloclinicfsm.features.chatbot.presentation.SelectLanguageDialog
import com.apolloclinicfsm.features.commondialog.presentation.CommonDialog
import com.apolloclinicfsm.features.commondialog.presentation.CommonDialogClickListener
import com.apolloclinicfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.apolloclinicfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.apolloclinicfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.apolloclinicfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.apolloclinicfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.apolloclinicfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.apolloclinicfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.apolloclinicfsm.features.damageProduct.ShopDamageProductListFrag
import com.apolloclinicfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.apolloclinicfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.apolloclinicfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.apolloclinicfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.apolloclinicfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.apolloclinicfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.apolloclinicfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.apolloclinicfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.apolloclinicfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.apolloclinicfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.apolloclinicfsm.features.device_info.presentation.DeviceInfoListFragment
import com.apolloclinicfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.apolloclinicfsm.features.document.DocumentRepoFeatureNewFragment
import com.apolloclinicfsm.features.document.presentation.DocumentListFragment
import com.apolloclinicfsm.features.document.presentation.DocumentTypeListFragment
import com.apolloclinicfsm.features.document.presentation.OpenFileWebViewFragment
import com.apolloclinicfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.apolloclinicfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.apolloclinicfsm.features.dymanicSection.presentation.DynamicListFragment
import com.apolloclinicfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.apolloclinicfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.apolloclinicfsm.features.home.presentation.HomeFragment
import com.apolloclinicfsm.features.homelocation.presentation.HomeLocationFragment
import com.apolloclinicfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.apolloclinicfsm.features.know_your_state.KnowYourStateFragment
import com.apolloclinicfsm.features.lead.LeadFrag
import com.apolloclinicfsm.features.lead.ViewLeadFrag
import com.apolloclinicfsm.features.leaveapplynew.LeaveHome
import com.apolloclinicfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.apolloclinicfsm.features.localshops.LocalShopListFragment
import com.apolloclinicfsm.features.localshops.LocalShopListMapFragment
import com.apolloclinicfsm.features.localshops.NearByShopsMapFragment
import com.apolloclinicfsm.features.location.*
import com.apolloclinicfsm.features.location.api.LocationRepoProvider
import com.apolloclinicfsm.features.location.model.*
import com.apolloclinicfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.apolloclinicfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.apolloclinicfsm.features.login.ShopFeedbackEntity
import com.apolloclinicfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.apolloclinicfsm.features.login.presentation.LoginActivity
import com.apolloclinicfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.apolloclinicfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.apolloclinicfsm.features.marketing.presentation.MarketingPagerFragment
import com.apolloclinicfsm.features.meetinglist.prsentation.MeetingListFragment
import com.apolloclinicfsm.features.member.MapViewForTeamFrag
import com.apolloclinicfsm.features.member.model.TeamLocDataModel
import com.apolloclinicfsm.features.member.model.TeamShopListDataModel
import com.apolloclinicfsm.features.member.presentation.*
import com.apolloclinicfsm.features.menuBeat.MenuBeatFrag
import com.apolloclinicfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.apolloclinicfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.apolloclinicfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.apolloclinicfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.apolloclinicfsm.features.myjobs.model.CustomerDataModel
import com.apolloclinicfsm.features.myjobs.presentation.*
import com.apolloclinicfsm.features.myorder.presentation.MyOrderListFragment
import com.apolloclinicfsm.features.myprofile.presentation.MyProfileFragment
import com.apolloclinicfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.apolloclinicfsm.features.nearbyshops.model.ShopData
import com.apolloclinicfsm.features.nearbyshops.model.ShopListResponse
import com.apolloclinicfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.apolloclinicfsm.features.nearbyshops.presentation.BeatListFragment
import com.apolloclinicfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.apolloclinicfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.apolloclinicfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.apolloclinicfsm.features.newcollection.CollectionDetailsStatusFragment
import com.apolloclinicfsm.features.newcollection.CollectionShopListFragment
import com.apolloclinicfsm.features.newcollection.NewCollectionListFragment
import com.apolloclinicfsm.features.newcollectionreport.*
import com.apolloclinicfsm.features.notification.NotificationFragment
import com.apolloclinicfsm.features.orderList.NewDateWiseOrderListFragment
import com.apolloclinicfsm.features.orderList.NewOrderListFragment
import com.apolloclinicfsm.features.orderList.OrderListFragment
import com.apolloclinicfsm.features.orderdetail.presentation.OrderDetailFragment
import com.apolloclinicfsm.features.orderhistory.ActivityMapFragment
import com.apolloclinicfsm.features.orderhistory.OrderhistoryFragment
import com.apolloclinicfsm.features.orderhistory.TimeLineFragment
import com.apolloclinicfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.apolloclinicfsm.features.orderhistory.model.FetchLocationRequest
import com.apolloclinicfsm.features.orderhistory.model.FetchLocationResponse
import com.apolloclinicfsm.features.orderhistory.model.LocationData
import com.apolloclinicfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.apolloclinicfsm.features.performance.GpsStatusFragment
import com.apolloclinicfsm.features.performance.PerformanceFragment
import com.apolloclinicfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.apolloclinicfsm.features.performance.model.UpdateGpsInputParamsModel
import com.apolloclinicfsm.features.performanceAPP.PerformanceAppFragment
import com.apolloclinicfsm.features.permissionList.ViewPermissionFragment
import com.apolloclinicfsm.features.photoReg.*
import com.apolloclinicfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.apolloclinicfsm.features.quotation.presentation.*
import com.apolloclinicfsm.features.reimbursement.presentation.*
import com.apolloclinicfsm.features.report.presentation.*
import com.apolloclinicfsm.features.returnsOrder.*
import com.apolloclinicfsm.features.settings.presentation.SettingsFragment
import com.apolloclinicfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.apolloclinicfsm.features.shopdetail.presentation.*
import com.apolloclinicfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.apolloclinicfsm.features.stock.StockDetailsFragment
import com.apolloclinicfsm.features.stock.StockListFragment
import com.apolloclinicfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.apolloclinicfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.apolloclinicfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.apolloclinicfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.apolloclinicfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.apolloclinicfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.apolloclinicfsm.features.survey.SurveyFrag
import com.apolloclinicfsm.features.survey.SurveyViewDtlsFrag
import com.apolloclinicfsm.features.survey.SurveyViewFrag
import com.apolloclinicfsm.features.task.presentation.AddTaskFragment
import com.apolloclinicfsm.features.task.presentation.CalenderTaskFragment
import com.apolloclinicfsm.features.task.presentation.EditTaskFragment
import com.apolloclinicfsm.features.task.presentation.TaskListFragment
import com.apolloclinicfsm.features.taskManagement.TaskManagementFrag
import com.apolloclinicfsm.features.taskManagement.ViewTaskManagementFrag
import com.apolloclinicfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.apolloclinicfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.apolloclinicfsm.features.timesheet.presentation.TimeSheetListFragment
import com.apolloclinicfsm.features.viewAllOrder.CartFragment
import com.apolloclinicfsm.features.viewAllOrder.OrderTypeListFragment
import com.apolloclinicfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.apolloclinicfsm.features.viewAllOrder.ViewCartFragment
import com.apolloclinicfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.apolloclinicfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.apolloclinicfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.apolloclinicfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.apolloclinicfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.apolloclinicfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.apolloclinicfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.apolloclinicfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.apolloclinicfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.apolloclinicfsm.features.viewPPDDStock.ViewStockFragment
import com.apolloclinicfsm.features.weather.presentation.WeatherFragment
import com.apolloclinicfsm.mappackage.MapActivity
import com.apolloclinicfsm.mappackage.MapActivityWithoutPath
import com.apolloclinicfsm.mappackage.SendBrod
...
import com.apolloclinicfsm.app.NewFileUtils.browsePDFDocuments
import com.apolloclinicfsm.features.marketAssist.MarketAssistTabFrag
import com.apolloclinicfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.apolloclinicfsm.features.marketAssist.ShopListMarketAssistFrag
import com.apolloclinicfsm.features.performanceAPP.OwnPerformanceFragment
import com.apolloclinicfsm.features.performanceAPP.allPerformanceFrag
import com.apolloclinicfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xapolloclinicfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.apolloclinicfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
