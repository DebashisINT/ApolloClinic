package com.apolloclinicfsm.app
...
import com.apolloclinicfsm.app.AppConstant.DBNAME
import com.apolloclinicfsm.app.domain.*
import com.apolloclinicfsm.features.lead.model.LeadActivityDao
import com.apolloclinicfsm.features.lead.model.LeadActivityEntity
...
//                        .fallbackToDestructiveMigration()
        ...
        val MIGRATION_2_3: Migration = object : Migration(2, 3) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                database.execSQL("create TABLE shop_extra_contact (id INTEGER NOT NULL PRIMARY KEY , shop_id TEXT , contact_serial TEXT, contact_name TEXT ,contact_dob TEXT, contact_number TEXT , contact_email TEXT , contact_doa TEXT , isUploaded INTEGER NOT NULL DEFAULT 0) ")
